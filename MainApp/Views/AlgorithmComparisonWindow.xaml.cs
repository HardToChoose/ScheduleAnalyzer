...
namespace MainApp.Views
{
    public partial class AlgorithmComparisonWindow : Window
    {
        ...
        private void SeriesButton_Click(object sender, MouseButtonEventArgs e)
        {
            var vm = DataContext as AlgorithmComparisonViewModel;
            var pair = vm.SelectedPlotAlgoPair;

            new PcsComparisonWindow
            {
                Owner = this.Owner,
                DataContext = new PcsComparisonViewModel(vm, vm.TestOptions, pair.Item1, pair.Item2),
                WindowStartupLocation = WindowStartupLocation.CenterOwner
            }
            .Show();
        }

        private void PlotCtrl_KeyDown(object sender, KeyEventArgs e)
        {
